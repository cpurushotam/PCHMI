...
CommConfig ServerParam = {
    ...
    .SecureConfigParam = {
        ...
        .ExpectedPeerName = "BransonHMI",                         /*Use this to configure Expected Host Name*/
        .SelfCertificate = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script3/server-cert.pem", /*Use this to configure Self Certificate*/
        .SelfPrivateKey = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script3/server-key.pem",   /*Use this to configure Self Encrypted Private Key*/
        .CACertificate = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script3/ca-cert.pem",       /*Use this to configure CA Certificate*/
        .PassKey = "ServerPass1$",                                  /*Use this to configure the password to be used during decryption of private key.
...
CommConfig ServerParam2 = {
    ...
    .SecureConfigParam = {
        ...
        .ExpectedPeerName = "BransonHMI",                         /*Use this to configure Expected Host Name*/
        .SelfCertificate = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script4/server-cert.pem", /*Use this to configure Self Certificate*/
        .SelfPrivateKey = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script4/server-key.pem",   /*Use this to configure Self Encrypted Private Key*/
