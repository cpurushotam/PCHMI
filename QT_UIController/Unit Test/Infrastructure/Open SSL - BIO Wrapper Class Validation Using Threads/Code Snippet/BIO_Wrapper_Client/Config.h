...
CommConfig ClientParam = {
    ...
    .ExpectedHostName = "BransonSC",         /*Use this to configure Expected Host Name*/
    .IsBlocking = true,                      /*Use this to configure Blocking or Non Blocking mode*/
    .SecureConfigParam = {
        .IsEnable = true,                    /*Use this to enable secure configuration*/
        .SelfCertificate = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script/client-cert.pem",/*Use this to configure Self Certificate*/
        .SelfPrivateKey = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script/client-key.pem", /*Use this to configure Self Private Key*/
        ...
        .PassKey = "ClientPass",                /*Use this to configure Passkey*/
...
CommConfig ClientParam2 = {
    ...
    .SecureConfigParam = {
        .IsEnable = true,                    /*Use this to enable secure configuration*/
        .SelfCertificate = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script2/client-cert.pem",/*Use this to configure Self Certificate*/
        .SelfPrivateKey = "/home/kshitij/Desktop/BIO_Wrapper_Test_Script2/client-key.pem",  /*Use this to configure Self Private Key*/
