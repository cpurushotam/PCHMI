...
---------------------------- MODULE DESCRIPTION ----------------------------
    TestGraphSettings.h file stores graph settings configured at user end.
--------------------------- REVISION HISTORY ------------------------------
 rev1: 13/03/2024 - Initial version.
***************************************************************************/
#ifndef TESTGRAPHSETTINGS_H
#define TESTGRAPHSETTINGS_H
#include <QObject>
#include <QSettings>
#include "TestSignature.h"


class TestGraphSettings : public QObject
{
    Q_OBJECT
...
public:
    ...
    explicit TestGraphSettings(QObject *parent = nullptr);
    QSettings settings;
...
public slots:
    ...
    void OnTestSignatureSettingsUpdated(TestSignature *TestSignatureSettings_Obj);
};

#endif // TESTGRAPHSETTINGS_H
