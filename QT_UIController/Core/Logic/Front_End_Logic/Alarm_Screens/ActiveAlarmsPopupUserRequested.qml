...
{
    id: eventlog
    property string qmlTextMenuName          : "Alarms/Warnings/Notifications/Service Reminder Log"
    property string qmlTextNewAlarmFound     : "New Alarms / Warnings / Notifications /Service Reminder Found"
    property string qmlTextErrorType         : "Error Type"
    property string qmlTextAlarmID           : "Alarm ID"
    property string qmlTextAction            : "Action"
    property string qmlTextAlarms            : "ALARMS / WARNINGS / NOTIFICATIONS / SERVICE REMINDER"
    ...
    property var qmlTextArray: [qmlTextNewAlarmFound, qmlTextErrorType, qmlTextAlarmID, qmlTextAlarms,
                                qmlTextAction, qmlTextReset, qmlTextResetAll, qmlTextViewDetails, qmlTextAlert, qmlTextInfo, qmlTextOK, qmlTextEmpty, qmlTextAlertMessage]
    ...
    QtObject
    {
        ...
        readonly property int textAlertMessageIdx      : 12
    }
    ...
    Connections{
        ...
        target: mainWindow
        function onResetButtonAccess()
        {
            resetAllBtn.buttonColor = UserPrivilegeObj.IsResetAlarmsAllowed || mainWindow.isAuthorityCheckEnable ? "#17345C" : "#9B9E9C"
        }
    }

    function resetAllButtonAccess(){
    ...
    Text
    {
        ...
        font.pixelSize: Math.round(Style.style0 * Style.scaleHint) *0.90
        font.bold: true
    }
        Rectangle
        {
        ...
        delegate: Rectangle
        {
            ...
            Rectangle
            {
                ...
                Text
                {
                    ...
                    text: (model.AlarmSubType !== alarmTypeEnum.alarmTypeServiceReminderIdx) ? ActiveAlarmDetailsListModel.getAlarmTypeString(model.AlarmID) :
                                                                                               model.AlarmServiceName
                    font.pixelSize: Math.round(Style.style3 * Style.scaleHint) * 0.90
                }
                    ...
                    onClicked:
                    {
                        ...
                        if(model.AlarmIsLogRequired)
                        {
                            if(ActiveScreen.CurrentActiveScreen !== UIScreenEnum.DIAGNOSTICS_ALARM)
                            {
                                ...
                                case alarmTypeEnum.alarmTypeServiceReminderIdx :
                                    /*To understand that screen is navigated from service reminder popup*/
                                    AlarmDetailsListModel.IsScreenNavigatedFromServiceReminderPopup = true
                                    break
                            ...
                            else
                            {
                                ...
                                case alarmTypeEnum.alarmTypeServiceReminderIdx :
                                    /*To understand that screen is navigated from service reminder popup*/
                                    AlarmDetailsListModel.isScreenNavigatedWhenAlarmLogIsVisibleFromServiceReminderPopup(true)
                                    break
    ...
    BransonPrimaryButton
    {
        ...
        buttonColor:resetAllButtonAccess()
        font.family: Style.regular.name
