...
***************************************************************************/
#ifndef CONFIG_READ_VERSION_USB_H
#define CONFIG_READ_VERSION_USB_H

#include "ConfigUpgradeCmdInterface.h"
#include <QString>

// ConfigReadVersionUSB class definition
class ConfigReadVersionUSB : public ConfigUpgradeCmdInterface
{    
    ...
    static constexpr uint8_t    DECRYPTION_FAILED       = 0X5;         /* Failed to decrypt config files */
    static constexpr uint8_t    VALIDATION_FAILED       = 0X6;         /* Failed to validate config files */
    static constexpr uint8_t    INVALID_VERSION_INFO    = 0X7;         /* Invalid version information */
...
#endif // CONFIG_READ_VERSION_USB_H
