...
This file includes configurations inputes needed for establishment of
    communication.
--------------------------- REVISION HISTORY ------------------------------
 rev1: 23/11/2023 - Initial version, configuration for client
 ***************************************************************************/

#ifndef BIO_PLATFORMCONFIGUPGRADE_H
#define BIO_PLATFORMCONFIGUPGRADE_H

#include "BIOConfig.h"

CommConfig SSLConfig =
{
    .RoleIs = CLIENT,                               /*Use this for defining the role i.e either Server or Client*/
    .DestinationIPandPort = {'8','0','8','2'},                 /*Use this for configuring destination Port, IP will configure by WDS */
    ...
    .SecureConfigParam = {
        ...
        .SelfCertificate = "../Developer_Certificates/developer-configClient-cert.pem",    /*Use this to configure Self Certificate*/
        .SelfPrivateKey = "../Developer_Certificates/developer-configClient-key.pem",      /*Use this to configure Self Encrypted Private Key*/
        .CACertificate = "../Developer_Certificates/developer-ca-cert.pem",          /*Use this to configure CA Certificate*/
        .PassKey = "../Developer_Certificates/developer-configClient-data.enc",            /*Use this to configure the password to be used during decryption of private key.*/
...
#endif // BIO_PLATFORMCONFIGUPGRADE_H
