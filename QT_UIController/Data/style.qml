...
** and conditions see https://www.qt.io/terms-conditisvgons. For further
...
KeyboardStyle {
    ...
    /*Custom color */
    readonly property color buttonColor: "#68A4EB"
    readonly property color keyBoardBackgroundColor: "#FFFFFF"
    ...
    readonly property string resourcePrefix: "qrc:/VirtualKeyboardStyles/QtQuick/VirtualKeyboard/Styles/styleVirtualKeyboard/images/"
    readonly property string inputLocale: InputContext.locale
    property color inputLocaleIndicatorColor: "black"//"white"
    property Timer inputLocaleIndicatorHighlightTimer: Timer {
        interval: 1000
        onTriggered: inputLocaleIndicatorColor = buttonColor
    }
    ...
    languageKeyPanel: KeyPanel {
        Rectangle {
            ...
            Image {
                ...
                smooth: false
                source: resourcePrefix + "globe.svg"
            }
        }
        states: [
            State {
        ...
        Rectangle {
            ...
            Image {
                ...
                source: {
                    ...
                    default:
                        return resourcePrefix + "enter.svg"
                    }
                }
            }
            Text {
    ...
    shiftKeyPanel: KeyPanel {
        Rectangle {
            ...
            Image {
                ...
                smooth: false
                source: resourcePrefix + "shift1.svg"
            }
            states: [
                State {
                    name: "capslock"
                    ...
                    PropertyChanges {
                        target: shiftKeyIcon
                        source: resourcePrefix + "shift2.svg"
                    }
                },
                State {
                    name: "shift"
    ...
    selectionHandle: Image {
        sourceSize.width: 20
        source: resourcePrefix + "selectionhandle-bottom.svg"
    }
